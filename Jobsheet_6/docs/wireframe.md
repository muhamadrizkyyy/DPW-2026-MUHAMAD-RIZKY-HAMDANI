...
+ **Member**: login untuk melihat riwayat peminjaman buku.
...
## User Flow — Register Member

```
[Tamu]  -> [Menu "Daftar"] -> [Form Register]
        -> [Simpan] -> [Login] -> [Dashboard Member]
```
...
## Wireframe: Halaman Register Member
